            ...
            <div className="weekly-report">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="radio-group">
                        {
                            ['Tốt', 'Bình thường', 'Khá', 'Xuống cấp'].map((status) => (
                                <label key={status}>
                                    <input type="radio" name="statusInternal"
                                        value={status} checked={formData.statusOverall === status}
                    ...
                    <div className="radio-group">
                        {
                            ['Tốt', 'Bình thường', 'Khá', 'Xuống cấp'].map((status) => (
                                <label key={status}>
                                    <input type="radio" name="statusExternal"
                                        value={status} checked={formData.statusExternal === status}
                                        onChange={handleInputChange} />
                                </label>
                            ))
                        }
                    ...
                    <textarea name="description" id="description"
                        ...
                        maxLength={300} placeholder="Mô tả tình trạng (tối đa 300 từ)" />
                </form>
